...
(function ($) {
    ...
    function Slide(ele, options) {
        ...
        this.states = [
            ...
            { '&zIndex': 3, width: 328, height: 530, top: 78, left: 20, $opacity: 1 },
            { '&zIndex': 4, width: 384, height: 684, top: 0, left: 262, $opacity: 1 },
            { '&zIndex': 3, width: 328, height: 530, top: 78, left: 578, $opacity: 1 }
